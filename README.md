...
- [ElromEvedElElyon/chainlink-sentinel](https://github.com/ElromEvedElElyon/chainlink-sentinel) 📇 🏠 - AI-powered cross-chain risk sentinel using Chainlink Data Feeds. 6 MCP tools for oracle monitoring, anomaly detection, and stablecoin depeg alerts across 6 EVM chains. Zero API keys.
